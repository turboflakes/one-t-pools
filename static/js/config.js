  ...
  services: [
    {
      ...
      cookies: [
        ...
        [/^_ga.*$/, "/", ".turboflakes.io"], //for the production version
        // [/^_ga.*$/, "/", "localhost:3000"], //for the local version
        ["_gid", "/", ".turboflakes.io"], //for the production version
        // ["_gid", "/", "localhost:3000"], //for the local version
      ],
